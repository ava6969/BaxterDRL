...
class LoadGazeboModelsWithTargetRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LoadGazeboModelsWithTargetRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LoadGazeboModelsWithTargetRequest
    let len;
    let data = new LoadGazeboModelsWithTargetRequest(null);
  ...
  static datatype() {
    ...
    return 'drl_project/LoadGazeboModelsWithTargetRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LoadGazeboModelsWithTargetRequest(null);
...
class LoadGazeboModelsWithTargetResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
    }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LoadGazeboModelsWithTargetResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LoadGazeboModelsWithTargetResponse
    let len;
    let data = new LoadGazeboModelsWithTargetResponse(null);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'drl_project/LoadGazeboModelsWithTargetResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LoadGazeboModelsWithTargetResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: LoadGazeboModelsWithTargetRequest,
  Response: LoadGazeboModelsWithTargetResponse,
  md5sum() { return '5f08058997a8852ae0a653fa727e7b80'; },
  datatype() { return 'drl_project/LoadGazeboModelsWithTarget'; }
};
