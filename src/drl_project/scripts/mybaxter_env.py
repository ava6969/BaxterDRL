...
class BaxterEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.max_valid_pos_y, self.min_valid_pos_y = 0.4, 0.2
        ...
        self.goal_space = spaces.Box(np.array([self.min_valid_pos_x, self.min_valid_pos_y, 0.0]), 
                                     np.array([self.max_valid_pos_x, self.max_valid_pos_y, 0.4]),
                                     dtype='float32')
    ...
    def step(self, action):
       ...
       # g_action = action[7]*50.0 + 50.0# -1*50 + 50 = 0 1*50 + 50 = 100
        ...
        self.set_torque_client(torque_list, 0)
       ...
       # print("diff goal - ee", mag_obs)
        ...
        reward = - mag_obs - excess_torque_penalty
        #print("reward: ", reward)
        #print("done ", done)
    ...
    def _sample_goal(self):
       ...
       # goal = self.goal_space.sample() + self.np_random.uniform(-self.u_bound_goal, self.u_bound_goal, size=3)
        ...
        return self.goal_space.sample() .copy()
